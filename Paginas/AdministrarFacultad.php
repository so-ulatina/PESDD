...
<body >
 ...
 ?> 
   ...
   <button onclick="agregar()" class="show-popup-agregar" ><span class="material-symbols-outlined">add </span></button>
                 ...
                 <form action="../SQLs/SQL-Facultad.php" class="filtros" method="POST" >
                    <div class="filtrar1">
                           <p>Nombre: </p>
...
<td  class="Estado">  <?php echo $row["Estado"]; ?> </td>
     ...
     <!-- ----------------------------------Fin de main , centro pagina---------------------------------- -->
        ...
        <form action="../SQLs/SQL-Facultad.php" method="POST">
    ...
    <div class="popup-container-editar">
        ...
        <form action="../SQLs/SQL-Facultad.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control"  name="Id_Facultade"  id="Id_Facultade" oninput="setCustomValidity('')" oninvalid="this.setCustomValidity('*Este campo no puede estar vacio*')" required/>
 ...
 <div class="separator"></div>
  ...
  <script src="../JavaScripts/JavaScript-Facultad.js"></script>
