    ...
    <main>
        ...
        <div class="tabla-centro">
            ...
            <div class="tabla">
                ...
                <form action="../SQLs/SQL-Administrador.php" class="filtros" method="POST" >
                    <div class="filtrar1">
                           <p>Nombre: </p>
...
<td  class="Estado">  <?php echo $row["Estado"]; ?> </td>
     ...
     <!-- ----------------------------------Fin de main , centro pagina---------------------------------- -->
        ...
        <form action="../SQLs/SQL-Administrador.php" method="POST">
    ...
    <div class="popup-container-editar">
        ...
        <form action="../SQLs/SQL-Administrador.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control"  name="Id_administradore"  id="Id_administradore" oninput="setCustomValidity('')" oninvalid="this.setCustomValidity('*Este campo no puede estar vacio*')" required/>
  ...
  <script src="../JavaScripts/JavaScript-Administrador.js"></script>
