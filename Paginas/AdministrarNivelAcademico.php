...
<body >
 ...
 ?> 
   ...
   <button onclick="agregar()" class="show-popup-agregar" ><span class="material-symbols-outlined">add </span></button>
                ...
                <form action="../SQLs/SQL-NivelAcademico.php" class="filtros" method="POST" >
                    <div class="filtrar1">
                           <p>Nombre: </p>
...
<td  class="Estado">  <?php echo $row["Estado"]; ?> </td>
     ...
     <!-- ----------------------------------Fin de main , centro pagina---------------------------------- -->
        ...
        <form action="../SQLs/SQL-NivelAcademico.php" method="POST">
    ...
    <div class="popup-container-editar">
        ...
        <form action="../SQLs/SQL-NivelAcademico.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control"  name="Id_NivelAcademicoe"  id="Id_NivelAcademicoe" oninput="setCustomValidity('')" oninvalid="this.setCustomValidity('*Este campo no puede estar vacio*')" required/>
        ...
        <form action="../SQLs/SQL-NivelAcademico.php" method="POST">
           ...
           <!-- Input para id Modalidad-->
            <div class="form-group">
                ...
                <input type="text" class="form-control"  name="Id_NivelAcademicoel"  id="Id_NivelAcademicoel" oninput="setCustomValidity('')" oninvalid="this.setCustomValidity('*Este campo no puede estar vacio*')" required/>
  ...
  <script src="../JavaScripts/JavaScript-NivelAcademico.js"></script>
