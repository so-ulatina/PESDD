...
<body >
 ...
 ?> 
   ...
   <button onclick="agregar()" class="show-popup-agregar" ><span class="material-symbols-outlined">add </span></button>
                 ...
                 <form action="../SQLs/SQL-Modalidad.php" class="filtros" method="POST" >
                    <div class="filtrar1">
...
<td  class="Estado">  <?php echo $row["Estado"]; ?> </td>
     ...
     <!-- ----------------------------------Fin de main , centro pagina---------------------------------- -->
        ...
        <form action="../SQLs/SQL-Modalidad.php" method="POST">
            ...
            <div class="form-group">
                <a class="sub">Descripci&oacuten:</a>
                
                <input type="text" class="form-control" name="Descripcion" id="Descripcion" oninput="setCustomValidity('')" oninvalid="this.setCustomValidity('*Este campo no puede estar vacio*')" required />
            </div>
    ...
    <div class="popup-container-editar">
        ...
        <form action="../SQLs/SQL-Modalidad.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control"  name="Id_modalidade"  id="Id_modalidade" oninput="setCustomValidity('')" oninvalid="this.setCustomValidity('*Este campo no puede estar vacio*')" required/>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="Descripcione" id="Descripcione" oninput="setCustomValidity('')" oninvalid="this.setCustomValidity('*Este campo no puede estar vacio*')" required />
            </div>
        ...
        <form action="../SQLs/SQL-Modalidad.php" method="POST">
           ...
           <!-- Input para id Modalidad-->
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="Descripcionel" id="Descripcionel" oninput="setCustomValidity('')" oninvalid="this.setCustomValidity('*Este campo no puede estar vacio*')" required />
            </div>
  ...
  <script src="../JavaScripts/JavaScript-Modalidad.js"></script>
