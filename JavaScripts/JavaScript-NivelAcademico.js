...
for (let button of allButtons) {
        button.addEventListener('click', function (e) {
            ...
            if ($popupScreen == "Editar") {
                ...
                let IdnivelAcademico = tr.getElementsByClassName("Id_NivelAcademico")[0].innerHTML;
                ...
                document.getElementById("Id_NivelAcademicoe").value = IdnivelAcademico.trim();
                document.getElementById("Nombree").value = Nombre.trim();

                document.getElementById("Id_NivelAcademicoe").readOnly = true;
            ...
            if ($popupScreen == "Eliminar") {
                ...
                document.getElementById("Id_NivelAcademicoel").value = IdnivelAcademico.trim();
